...
# Used to handle issues with playsound3 and pyinstaller
# These imports were generated by Anthropic Claude Sonnet 4.6 Low
# Use: Handling issue with playsound3 and pyinstaller
import sys
import os
...
# Generated by Anthropic Claude Sonnet 4.6 Low
# Use: Was having issues with playsound3 and pyinstaller and used Claude to help. 
...
class PomodoroApp:   
    ...
    reset_timer()   - resets the timer to original state (idle and ready to 
                        start a "work" session)
    countdown()     - counts down the timer to 00:00 
    end_timer()     - handles the end of the timer
    popupMsg()     - handles popups (in retrospect, probably not needed)
    get_display_time - returns time as MM:SS String
    """
    def __init__(self, root):
        ...
        # App Icon: hidden for now because ran into issues with pyinstaller
    ...
    def start_timer(self):
        playsound(resource_path("Sound_effects\\506054__mellau__button-click-1.wav"), False)
    ...
    def end_timer(self):
        ...
        self.state_label.config(text='Please click "Start"')
        return
    
    def popupMsg(self, title, msg):
        # This function might not be necessary now that I think about it...
        messagebox.showinfo(title=title, message=msg)
        return
    
    def get_display_time(self, minute):
        # Update display with time
        minutes_txt = str(int(minute / 60))
        # Pad minutes with leading zeros 
        seconds_txt = str(int(minute % 60)).zfill(2)
